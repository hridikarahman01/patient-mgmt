...
<body>
    ...
    <section class="container mt-5">
        <form class="row g-3"action="booking_test.php" method="POST">

        <div class="col-md-6">
                                    <label for="inputSlot" class="form-label">TEST</label>
                                        <select class="form-select" name="test">
                                            ...
                                            <?php
                                              ...
                                              $records = mysqli_query($db, "SELECT DISTINCT test_name From test");  // Use select query here
              ...
              <div class="col-md-4">
                ...
                <input type="aptdt" class="form-control" id="inputaptdt" placeholder="YYYY-MM-DD" name="date">
              </div>
